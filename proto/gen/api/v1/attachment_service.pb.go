...
type Attachment struct {
	...
	IsBlurred     bool `protobuf:"varint,9,opt,name=is_blurred,json=isBlurred,proto3" json:"is_blurred,omitempty"`
...
func (x *Attachment) GetIsBlurred() bool {
	if x != nil {
		return x.IsBlurred
	}
	return false
...
const file_api_v1_attachment_service_proto_rawDesc = "" +
	...
	"\n" +
	"is_blurred\x18\t \x01(\bB\x03\xe0A\x01R\tisBlurred:O\xeaAL\n" +
