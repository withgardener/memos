...
export type Attachment = Message<"memos.api.v1.Attachment"> & {
  ...
  /**
   * Optional. Whether the image attachment should be blurred by default in the UI.
   *
   * @generated from field: bool is_blurred = 9;
   */
  isBlurred: boolean;
};
